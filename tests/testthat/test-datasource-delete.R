...
test_that("delete_datasource", {
  ...
  expect(delete_datasource(get_datasource_id_from_name(get_project_id_from_name("PROJECT_TESTU"), "HIVE_DATASOURCE_RAW_TESTU")) == 200, "delete_datasource() doesn't retrieve a 200 status code for HIVE_DATASOURCE_RAW_TESTU")
  expect(delete_datasource(get_datasource_id_from_name(get_project_id_from_name("PROJECT_TESTU"), "HIVE_DATASOURCE_REQUEST_TESTU")) == 200, "delete_datasource() doesn't retrieve a 200 status code for HIVE_DATASOURCE_REQUEST_TESTU")
  # expect(delete_datasource(get_datasource_id_from_name(get_project_id_from_name("PROJECT_TESTU"), "HBASE_DATASOURCE_RAW_TESTU")) == 200, "delete_datasource() doesn't retrieve a 200 status code for HBASE_DATASOURCE_RAW_TESTU")
  # expect(delete_datasource(get_datasource_id_from_name(get_project_id_from_name("PROJECT_TESTU"), "HDFS_DATASOURCE_RAW_TESTU")) == 200, "delete_datasource() doesn't retrieve a 200 status code for HDFS_DATASOURCE_RAW_TESTU")
